...
classes: wide
---
<p align="center">({{ site.url }}{{ site.baseurl }}/images/posts/post_2022_SOBP_1.png )</p>
...
<p align="center">({{ site.url }}{{ site.baseurl }}/images/posts/post_2022_SOBP_2.png ){: width="70%" height="70%"}</p>
